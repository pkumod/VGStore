...
Reference: RDFLib - SPARQL 1.1 Parser
...
from rdflib.plugins.sparql.parserutils import Comp, Param, ParamList
...
VARNAME = Regex(
    "[%s0-9][%s0-9\u00B7\u0300-\u036F\u203F-\u2040]*" % (PN_CHARS_U_re + MM_INDICATOR, PN_CHARS_U_re),
    flags=re.U,
)
